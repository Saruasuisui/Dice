...
var numberOfTimeToRoll = prompt("how many time do you want to roll the dice?");
...
function whoWon() {
    ...
    document.querySelector("h3").innerHTML = banner + "<br>" + outcome + " You have rolled "
    + numberOfTimeToRoll + " times and your balance is "+balance + " now.";
}
...
function letsPlay(){
  ...
  // Parameter 1: ID of each game
  // Parameter 2: Time (in milliseconds)
  //QueryUpdate( test, 2000);

for(i=1;i<=numberOfTimeToRoll;i++){
